                ...
                <slot name="body">
                    ...
                    <div class="wrapper-right">
                        <div class="cart-list-container">
                            <ul class="cart-list">
                                <li class="cart-list-items" v-for="item in cart" :key="item.id">
                                    <div class="cart-list-items-left">
                                        <h3 class="cart-list-items-name">{{item.name}}</h3>
                                    </div>
                                    <div class="cart-list-items-center">
                                        <h3 class="cart-list-items-quantity">(x{{item.quantity}})</h3>
                                    </div>
                                    <div class="cart-list-items-right">
                                        <h3 class="cart-list-items-price">Rp. {{item.totalPrice.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")}}</h3>
                                    </div>

                                    <div class="flex-break"></div>

                                    <h5 class="cart-list-items-notes">{{item.notes.join(' | ')}}</h5>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="cta-container">
                            <button class="checkout-button" @click="submitPayment()">
...
export default {
    ...
    methods:{
        getData(payload){
            ...
            this.inputsKeyboard['bayar'] = "";
            this.inputsKeyboard['note'] = "";
        ...
        submitPayment(){
            ...
            if (this.selectedMethod !== '') {
                ...
                if (this.kembalian >= 0) {
                    ...
                    axios.post("/storeOrder", formData)
                    .then(response => {
                        console.log('ok');
